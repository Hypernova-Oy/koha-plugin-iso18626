...
use Koha::Plugin::ISO18626::BackgroundTasks;
use Koha::Plugin::ISO18626::Install;
use Koha::Plugin::ISO18626::OpenAPI;
...
sub install {
    return Koha::Plugin::ISO18626::Install::install(@_);
}

sub uninstall {
    return Koha::Plugin::ISO18626::Install::uninstall(@_);
}

sub upgrade {
    return Koha::Plugin::ISO18626::Install::upgrade(@_);
}

sub cronjob_nightly {
    return Koha::Plugin::ISO18626::BackgroundTasks::cronjob_nightly(@_);
}

sub api_routes {
    Koha::Plugin::ISO18626::OpenAPI::api_routes(@_);
}

sub api_spec {
    Koha::Plugin::ISO18626::OpenAPI::api_spec(@_);
}
...
sub configure {
    return Koha::Plugin::ISO18626::Install::configure(@_);
}
...
sub intranet_js {
    ...
    if (document.querySelector("body#pat_member-flags") !== null) {
        // Koha::Plugin::ISO18626::intranet_js() permission description injections
...
sub _CheckBranchBlock {
    ...
    my $block = Koha::Plugin::ISO18626::BlockManager::hasBlock($patron, $requestingBranchcode);
    if ($block) {
