package Koha::Plugin::ISO18626::BlockManager;
...
use C4::Context;
use Koha::Plugin::ISO18626::Block;
use Koha::Plugin::ISO18626::Log qw(toString);
...
my $plugin = Koha::Plugin::ISO18626->new();
...
sub createBlock {
    ...
    return Koha::Plugin::ISO18626::Block->new($b);
}

=head2 deleteBlock

 @param1 {Koha::Plugin::ISO18626::Block || Integer} Do not use Integer if possible.
 @returns {Integer} The number of rows affected. See DBI::execute
 @throws Koha::Exceptions::Exception
...
=head2 getBlock
 ...
 @returns {Koha::Plugin::ISO18626::Block}
 @throws Koha::Exceptions::Exception
...
sub getBlock {
    ...
    bless($block, 'Koha::Plugin::ISO18626::Block') if ($block);
...
=head2 hasBlock
 ...
 @returns {Koha::Plugin::ISO18626::Block or undef}
...
sub hasBlock {
    ...
    Koha::Exceptions::Exception->throw(error => $dbh->errstr()) if $dbh->errstr();
    $block = bless($block, 'Koha::Plugin::ISO18626::Block') if ($block);
...
=head2 listBlocks
 ...
 @returns {ARRAYRef of Koha::Plugin::ISO18626::Block}
 @throws Koha::Exceptions::Exception
...
sub listBlocks {
    ...
    Koha::Exceptions::Exception->throw(error => $dbh->errstr()) if $dbh->errstr();
    @blocks = map {my $b = $_; bless($b, 'Koha::Plugin::ISO18626::Block')} @blocks;
    return \@blocks;
}

=head2 storeBlock

Persist a Koha::Plugin::ISO18626::Block to the DB

 @param1 {Koha::Plugin::ISO18626::Block}
 @throws Koha::Exceptions::Exception
