...
subtest 'Opening hours happy path' => sub {
    ...
    ok(Koha::Plugin::Fi::KohaSuomi::SelfService::isLibraryOpen('CPL'),
        'Branch CPL is open now');
    ok(Koha::Plugin::Fi::KohaSuomi::SelfService::isLibraryOpen('FFL'),
        'Branch FFL has just opened');
    sleep(1); #Wait a second, because ending time is inclusive.
    ok(! Koha::Plugin::Fi::KohaSuomi::SelfService::isLibraryOpen('IPL'),
        'Branch IPL has just closed');
    ok(! Koha::Plugin::Fi::KohaSuomi::SelfService::isLibraryOpen('MPL'),
...
subtest 'Daily opening hours' => sub {
    ...
    ok(! Koha::Plugin::Fi::KohaSuomi::SelfService::isLibraryOpen('IPT', $today),
